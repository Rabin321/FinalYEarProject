...
def predictornb(request):
    if request.method == 'POST':
        ...
        print("Accuracy svm " + accnb)
        #accnb = test_data_accuracy_nb * 100
        ...
        if cmnt_predict == 0 and cmnt_predict2 == 0:
            ...
            return render(request, '1.html', {'result1': 'SVM: This comment seems to be toxic.  Accuracy of SVM:' + accsvm,
                                              'result2': 'NB: Your comment is acceptable. Accuracy of NB:' + accnb,
                                              })
        elif cmnt_predict == 0 and cmnt_predict2 == 1:
            return render(request, '1.html', {'result1': 'SVM: Your comment is acceptable. Accuracy of SVM:' + accsvm,
                                              'result2': 'NB: This comment seems to be toxic. Accuracy of NB:' + accnb,
                                              })
        else:
            return render(request, '1.html', {'result1': 'SVM: This comment seems to be toxic. Accuracy of SVM:' + accsvm,
                                              'result2': 'NB: This comment seems to be toxic. Accuracy of NB:' + accnb,
